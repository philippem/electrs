...
fn test_rest_address_utxo() -> Result<()> {
    ...
    assert_eq!(utxos[0]["status"]["block_height"].as_u64(), Some(102));
...
fn test_rest_tx_outspends() -> Result<()> {
    ...
    assert_eq!(spent_entry["status"]["block_height"].as_u64(), Some(102));
...
fn test_rest_liquid_confidential_tx() -> Result<()> {
    ...
    assert_eq!(tx["status"]["block_height"].as_u64(), Some(102));
